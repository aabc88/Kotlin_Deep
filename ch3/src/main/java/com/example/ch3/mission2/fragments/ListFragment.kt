    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        menuHost.addMenuProvider(object : MenuProvider {
            ...
            override fun onCreateMenu(menu: Menu, menuInflater: MenuInflater) {
                    ...
                    override fun onQueryTextSubmit(query: String?): Boolean {
                        ...
                        query?.run {
                            searchViewModel.insertSearch(
                                /*com.example.ch3.mission2.room.Search(
                                    searchTxt = query
                                )*/
                                Search(0, query)
                            )
                ...
                //fragment를 위한 코루틴 스코프는 두개 제공한다.
                //lifecycleScope - fragment가 종료 될 떄까지
                //fragment가 살아 있다 해도 fragment가 출력한 뷰가 제거 될 때까지
                viewLifecycleOwner.lifecycleScope.launch {
                    //flow데이터 발행 구독 UI에 방해되지 않게 코루틴으로
